            ...
            [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return "<div href='" + row.id + "' class='m_c_e-btn-edit' style='text-decoration:underline;cursor:pointer' title='Редактировать'>" + row.surname + " " + row.name + " " + row.patronymic + "</div>";
                    },
                    width: '350px'
                },
                {
